  ...
  return (
    <View>
        ...
        <View style={styles.Container}>
            <Text style={styles.blackText}>1: No experience</Text>
        </View>
        <View style={styles.Container}>
            <Text style={styles.blackText}>2: I worked out once or twice</Text>
        </View>
        <View style={styles.Container}>
            <Text style={styles.blackText}>3: I sometimes work out</Text>
        </View>
        <View style={styles.Container}>
            <Text style={styles.blackText}>4: I regularly work out</Text>
        </View>
        <View style={styles.Container}>
            <Text style={styles.blackText}>5: I am a professional</Text>
        </View>
